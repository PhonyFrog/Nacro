...
{
	static auto Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "ForceRefreshTab");
...
{
	static auto Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "RegisterCraftingCompare");
...
{
	static auto Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "HandleDropItemCallback");
...
{
	static auto Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "DropItem");
...
{
	static auto Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "CreateQuantitySelectorWidget");
...
{
	static auto Func = Class->GetFunction("ItemManagementDetailsModeBox_C", "DestroyQuantitySelectorWidget");
