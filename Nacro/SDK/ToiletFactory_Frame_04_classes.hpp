...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("ToiletFactory_Frame_04_C");
		return Clss;
	}
	...
	void OnLootRepeat();
	void OnBeginSearch();
	void ExecuteUbergraph_ToiletFactory_Frame_04(int32 EntryPoint, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue);
};
