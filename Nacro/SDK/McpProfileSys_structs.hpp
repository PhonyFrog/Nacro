...
public:
	...
	uint8                                        Pad_C21[0xD0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C22[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_C23[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_C24[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
