...
public:
	...
	class UWidget*                               K2Node_ComponentBoundEvent_ActiveWidget;           // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UEulaTab_C*                            K2Node_DynamicCast_AsEula_Tab;                     // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_36C2[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UThirdPartyTab_C*                      K2Node_DynamicCast_AsThird_Party_Tab;              // 0x40(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UIconTextButton_C*                     K2Node_DynamicCast_AsIcon_Text_Button;             // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortUIManagerWidget_NUI*              CallFunc_GetUIManagerWidget_ReturnValue;           // 0x78(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
