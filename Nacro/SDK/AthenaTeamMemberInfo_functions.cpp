...
{
	static auto Func = Class->GetFunction("AthenaTeamMemberInfo_C", "ShowPlayerInfo");

	Params::UAthenaTeamMemberInfo_C_ShowPlayerInfo_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaTeamMemberInfo_C", "ShowConnecting");

	Params::UAthenaTeamMemberInfo_C_ShowConnecting_Params Parms;
