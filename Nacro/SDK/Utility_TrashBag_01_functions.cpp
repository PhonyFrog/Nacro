...
{
	static auto Func = Class->GetFunction("Utility_TrashBag_01_C", "UserConstructionScript");

	Params::AUtility_TrashBag_01_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("Utility_TrashBag_01_C", "OnLoot");

	Params::AUtility_TrashBag_01_C_OnLoot_Params Parms;
...
{
	static auto Func = Class->GetFunction("Utility_TrashBag_01_C", "OnLootRepeat");

	Params::AUtility_TrashBag_01_C_OnLootRepeat_Params Parms;
...
{
	static auto Func = Class->GetFunction("Utility_TrashBag_01_C", "OnBeginSearch");

	Params::AUtility_TrashBag_01_C_OnBeginSearch_Params Parms;
