...
bool UNavLocalGridManager::FindLocalNavigationGridPath(class UObject* WorldContext, struct FVector& Start, struct FVector& End, TArray<struct FVector>* PathPoints)
{
...
int32 UNavLocalGridManager::AddLocalNavigationGridForPoint(class UObject* WorldContext, struct FVector& Location, int32 Radius2D, float Height, bool bRebuildGrids)
{
...
int32 UNavLocalGridManager::AddLocalNavigationGridForCapsule(class UObject* WorldContext, struct FVector& Location, float CapsuleRadius, float CapsuleHalfHeight, int32 Radius2D, float Height, bool bRebuildGrids)
{
...
int32 UNavLocalGridManager::AddLocalNavigationGridForBox(class UObject* WorldContext, struct FVector& Location, const struct FVector& Extent, const struct FRotator& Rotation, int32 Radius2D, float Height, bool bRebuildGrids)
{
