...
// Function TracerGeneric_Athena_Scope.TracerGeneric_Athena_Scope_C.GetLocalPawnForPassBy
...
class AFortPlayerPawn* ATracerGeneric_Athena_Scope_C::GetLocalPawnForPassBy(class APawn* CallFunc_GetInstigator_ReturnValue, TArray<class AFortPlayerController*>& CallFunc_GetLocalFortPlayerControllers_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class AFortPlayerController* CallFunc_Array_Get_Item, bool CallFunc_Greater_IntInt_ReturnValue, class AFortPlayerPawn* CallFunc_GetPlayerPawn_ReturnValue, bool CallFunc_NotEqual_ObjectObject_ReturnValue)
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_Scope_C", "GetLocalPawnForPassBy");

	Params::ATracerGeneric_Athena_Scope_C_GetLocalPawnForPassBy_Params Parms;
...
// Function TracerGeneric_Athena_Scope.TracerGeneric_Athena_Scope_C.PlayPassBySound
...
// Function TracerGeneric_Athena_Scope.TracerGeneric_Athena_Scope_C.TrackPassBy
...
// Function TracerGeneric_Athena_Scope.TracerGeneric_Athena_Scope_C.UserConstructionScript
// (Event, Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FHitResult                  CallFunc_K2_SetRelativeRotation_SweepHitResult                   (IsPlainOldData, NoDestructor, ContainsInstancedReference)

void ATracerGeneric_Athena_Scope_C::UserConstructionScript(const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult)
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_Scope_C", "UserConstructionScript");

	Params::ATracerGeneric_Athena_Scope_C_UserConstructionScript_Params Parms;
	Parms.CallFunc_K2_SetRelativeRotation_SweepHitResult = CallFunc_K2_SetRelativeRotation_SweepHitResult;

	UObject::ProcessEvent(Func, &Parms);
}

// Function TracerGeneric_Athena_Scope.TracerGeneric_Athena_Scope_C.ReceiveTick
// (Event, Public, BlueprintEvent)
// Parameters:
// float                              DeltaSeconds                                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ATracerGeneric_Athena_Scope_C::ReceiveTick(float DeltaSeconds)
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_Scope_C", "ReceiveTick");

	Params::ATracerGeneric_Athena_Scope_C_ReceiveTick_Params Parms;
	Parms.DeltaSeconds = DeltaSeconds;

	UObject::ProcessEvent(Func, &Parms);
}

// Function TracerGeneric_Athena_Scope.TracerGeneric_Athena_Scope_C.OnInit
...
void ATracerGeneric_Athena_Scope_C::OnInit(struct FVector& Start, struct FVector& End)
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_Scope_C", "OnInit");

	Params::ATracerGeneric_Athena_Scope_C_OnInit_Params Parms;
	Parms.Start = Start;
	Parms.End = End;
...
// Function TracerGeneric_Athena_Scope.TracerGeneric_Athena_Scope_C.ExecuteUbergraph_TracerGeneric_Athena_Scope
// (HasDefaults)
// Parameters:
...
void ATracerGeneric_Athena_Scope_C::ExecuteUbergraph_TracerGeneric_Athena_Scope(int32 EntryPoint, float K2Node_Event_DeltaSeconds, bool CallFunc_TrackPassBy_Changed, float CallFunc_TrackPassBy_Pass_Distance, bool CallFunc_Not_PreBool_ReturnValue, const struct FVector& K2Node_Event_Start, const struct FVector& K2Node_Event_End, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_TrackPassBy_Changed2, float CallFunc_TrackPassBy_Pass_Distance2, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue2, float CallFunc_MapRangeClamped_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue)
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_Scope_C", "ExecuteUbergraph_TracerGeneric_Athena_Scope");

	Params::ATracerGeneric_Athena_Scope_C_ExecuteUbergraph_TracerGeneric_Athena_Scope_Params Parms;
