...
{
	static auto Func = Class->GetFunction("NiagaraFunctionLibrary", "SpawnEffectAttached");
...
{
	static auto Func = Class->GetFunction("NiagaraFunctionLibrary", "SpawnEffectAtLocation");
