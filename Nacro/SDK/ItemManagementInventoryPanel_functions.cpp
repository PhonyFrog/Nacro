...
{
	static auto Func = Class->GetFunction("ItemManagementInventoryPanel_C", "HandleMulchQuantityCallback");
...
{
	static auto Func = Class->GetFunction("ItemManagementInventoryPanel_C", "DestroyMulchQuantitySelector");
...
{
	static auto Func = Class->GetFunction("ItemManagementInventoryPanel_C", "CreateMulchQuantitySelector");
...
{
	static auto Func = Class->GetFunction("ItemManagementInventoryPanel_C", "HandleMulchQuantitySelection");
