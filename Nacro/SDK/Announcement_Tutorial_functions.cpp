...
// Parameters:
// struct FFortClientAnnouncementData_TutorialTutorialData                                                     (Parm)
// class UOverlaySlot*                ContentBoxSlot                                                   (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortClientAnnouncementData_TutorialLocalTutorialData                                                (Edit)
// bool                               CallFunc_TextIsEmpty_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
// enum class ESlateVisibility        CallFunc_GetLightboxVisibility_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class UCommonUserWidget*           NewLine                                                          (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UTutorialRichText_C*         CallFunc_Create_ReturnValue                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UTutorialTransparentRichText_C*CallFunc_Create_ReturnValue2                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UPanelSlot*                  CallFunc_AddChild_ReturnValue                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAnnouncement_Tutorial_C::AddTextLine(class FText Text, bool Transparent, class UCommonUserWidget* NewLine, class FText LocalText, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, class UTutorialRichText_C* CallFunc_Create_ReturnValue, class UTutorialTransparentRichText_C* CallFunc_Create_ReturnValue2, class UPanelSlot* CallFunc_AddChild_ReturnValue)
{
...
void UAnnouncement_Tutorial_C::ExecuteUbergraph_Announcement_Tutorial(int32 EntryPoint, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FFortClientAnnouncementData_Tutorial& K2Node_MakeStruct_FortClientAnnouncementData_Tutorial, class UObject* K2Node_HandleClientEvent_EventSource2, class UObject* K2Node_HandleClientEvent_EventFocus2, const struct FFortClientEvent& K2Node_HandleClientEvent_ClientEvent2, class UObject* K2Node_HandleClientEvent_EventSource, class UObject* K2Node_HandleClientEvent_EventFocus, const struct FFortClientEvent& K2Node_HandleClientEvent_ClientEvent, const struct FFortClientAnnouncementData_Tutorial& K2Node_CustomEvent_TutorialData, bool K2Node_CustomEvent_bShow, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, class UFortTutorialContext* CallFunc_GetContext_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue2)
{
