...
void UItemInspectEvolutionConfirmation_C::UnselectOtherEvolutions(int32 SelectedIndex, int32 Temp_int_Variable, bool CallFunc_NotEqual_IntInt_ReturnValue, class UWidget* CallFunc_GetChildAt_ReturnValue, class UItemInspectEvolutionChoiceEntry_C* K2Node_DynamicCast_AsItem_Inspect_Evolution_Choice_Entry, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_GetChildrenCount_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("ItemInspectEvolutionConfirmation_C", "UnselectOtherEvolutions");

	Params::UItemInspectEvolutionConfirmation_C_UnselectOtherEvolutions_Params Parms;
...
void UItemInspectEvolutionConfirmation_C::HandleEvolutionOptionSelected(class UFortItem* Item, int32 RecipeIndex, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue)
{
...
{
	static auto Func = Class->GetFunction("ItemInspectEvolutionConfirmation_C", "HandleEvolutionOptionUnhovered");

	Params::UItemInspectEvolutionConfirmation_C_HandleEvolutionOptionUnhovered_Params Parms;
	Parms.Item = Item;
...
void UItemInspectEvolutionConfirmation_C::HandleEvolutionOptionHovered(class UFortItem* Item, int32 RecipeIndex)
{
	static auto Func = Class->GetFunction("ItemInspectEvolutionConfirmation_C", "HandleEvolutionOptionHovered");

	Params::UItemInspectEvolutionConfirmation_C_HandleEvolutionOptionHovered_Params Parms;
	Parms.Item = Item;
	Parms.RecipeIndex = RecipeIndex;
...
void UItemInspectEvolutionConfirmation_C::ExecuteUbergraph_ItemInspectEvolutionConfirmation(int32 EntryPoint, class UCommonButton* K2Node_ComponentBoundEvent_Button)
{
