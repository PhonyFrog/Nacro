...
public:
	...
	struct FTimerHandle                          IconSlideHandle;                                   // 0x270(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	struct FTimerHandle                          IconInitHandle;                                    // 0x280(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	void SlideIcon(class URewardsIcon_C* Icon, float CallFunc_BreakVector2D_X, float CallFunc_BreakVector2D_Y, float CallFunc_BreakVector2D_X2, float CallFunc_BreakVector2D_Y2, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue2);
	...
	void RandomizeDesignView(class URewardsIcon_C* CallFunc_QueueReward_OutIcon, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_RandomInteger_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue2, bool CallFunc_LessEqual_IntInt_ReturnValue);
