...
public:
	...
	float                                        Temp_float_Variable2;                              // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FSchematicRequirement>         CallFunc_GetSchematicRequirements_Requirements;    // 0x18(0x10)(ZeroConstructor, ReferenceParm)
	struct FSchematicRequirement                 CallFunc_Array_Get_Item;                           // 0x28(0x10)(NoDestructor)
	...
	struct FMargin                               K2Node_MakeStruct_Margin;                          // 0x40(0x10)(NoDestructor)
	...
	class USchematicTooltipCraftingIngredient_C* CallFunc_Create_ReturnValue;                       // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UHorizontalBoxSlot*                    CallFunc_AddChildToHorizontalBox_ReturnValue;      // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
