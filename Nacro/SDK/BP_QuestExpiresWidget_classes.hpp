...
public:
	...
	void Refresh_Expiration_Timer(class UFortQuestItem* Quest, bool Temp_bool_Variable, bool CallFunc_DoesQuestExpire_ReturnValue, class AFortPlayerController* CallFunc_GetFortPC_AsFort_Player_Controller, const struct FTimespan& CallFunc_GetPlayerControllerUtcNowMcpOffset_ReturnValue, const struct FTimespan& CallFunc_GetRemainingExpirationDuration_ReturnValue, class FText CallFunc_GetTimespanAsText_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData2, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array2, class FText CallFunc_Format_ReturnValue, class FText CallFunc_Format_ReturnValue2, class FText K2Node_Select_Default);
	void PreConstruct(bool IsDesignTime);
	void SetData(class UFortQuestItem* InItem);
	void OnQuestExpirationUpdated();
	void ExecuteUbergraph_BP_QuestExpiresWidget(int32 EntryPoint, enum class ESlateVisibility Temp_byte_Variable, bool CallFunc_DoesQuestExpire_ReturnValue, enum class ESlateVisibility Temp_byte_Variable2, bool K2Node_Event_IsDesignTime, class UFortQuestItem* K2Node_Event_InItem, bool Temp_bool_Variable, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue2, bool CallFunc_BooleanAND_ReturnValue, enum class ESlateVisibility K2Node_Select_Default);
};
