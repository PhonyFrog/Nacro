...
public:
	...
	struct FGameplayCueParameters                K2Node_MakeStruct_GameplayCueParameters;           // 0x2E0(0xB8)(ContainsInstancedReference)
	class UFortAbilityTask_PlayMontageWaitTarget* CallFunc_PlayMontageInfoAndWaitForTrigger_ReturnValue; // 0x398(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayEventData                    K2Node_Event_EventData;                            // 0x3A0(0xA8)(ConstParm)
