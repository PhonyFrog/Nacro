...
{
	static auto Func = Class->GetFunction("WaterHeater01_C", "UserConstructionScript");

	Params::AWaterHeater01_C_UserConstructionScript_Params Parms;
...
void AWaterHeater01_C::OnDamagePlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("WaterHeater01_C", "OnDamagePlayEffects");

	Params::AWaterHeater01_C_OnDamagePlayEffects_Params Parms;
	Parms.Damage = Damage;
...
void AWaterHeater01_C::OnDeathPlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("WaterHeater01_C", "OnDeathPlayEffects");

	Params::AWaterHeater01_C_OnDeathPlayEffects_Params Parms;
	Parms.Damage = Damage;
	Parms.DamageTags = DamageTags;
	Parms.Momentum = Momentum;
	Parms.HitInfo = HitInfo;
