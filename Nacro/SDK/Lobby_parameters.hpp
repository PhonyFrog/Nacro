...
{
public:
	struct FUniqueNetIdRepl                      InUniqueId;                                        // 0x0(0x18)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FUniqueNetIdRepl                      InPartyOwnerId;                                    // 0x18(0x18)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FUniqueNetIdRepl                      InUniqueId;                                        // 0x10(0x18)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                UrlString;                                         // 0x28(0x10)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FUniqueNetIdRepl                      PlayerToKick;                                      // 0x0(0x18)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                  Reason;                                            // 0x18(0x18)(ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FUniqueNetIdRepl                      InUniqueId;                                        // 0x18(0x18)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
