...
void UQuestScreen_C::AbandonQuest(bool* PassThrough, bool CallFunc_AbandonQuest_questAbandoned_)
{
	static auto Func = Class->GetFunction("QuestScreen_C", "AbandonQuest");

	Params::UQuestScreen_C_AbandonQuest_Params Parms;
...
void UQuestScreen_C::ExecuteUbergraph_QuestScreen(int32 EntryPoint, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class UFortQuestManager* CallFunc_GetQuestManager_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, bool Temp_bool_Variable, class UUserWidget* K2Node_ComponentBoundEvent_Widget2, class FName K2Node_ComponentBoundEvent_TabId2, class UCommonButton* K2Node_ComponentBoundEvent_TabButton, class UQuestTreeEntry_C* K2Node_DynamicCast_AsQuest_Tree_Entry, bool K2Node_DynamicCast_bSuccess, class UIconTextButton_C* K2Node_DynamicCast_AsIcon_Text_Button, bool K2Node_DynamicCast_bSuccess2, class UFortUINavigationManager* CallFunc_GetUINavigationManager_ReturnValue, class FName K2Node_ComponentBoundEvent_TabId, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate3, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate4, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate5, class UFortMatchmakingContext* CallFunc_GetContext_ReturnValue2, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate6, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, class UObject* CallFunc_GetItemAt_ReturnValue, class UUserWidget* K2Node_ComponentBoundEvent_Widget, TArray<class UObject*>& CallFunc_OnGetChildrenForCategory_ReturnValue, class UQuestTreeEntry_C* K2Node_DynamicCast_AsQuest_Tree_Entry2, bool K2Node_DynamicCast_bSuccess3, int32 CallFunc_Array_Length_ReturnValue, class UObject* CallFunc_Array_Get_Item, bool CallFunc_Greater_IntInt_ReturnValue, class UObject* K2Node_Select_Default, bool CallFunc_Array_RemoveItem_ReturnValue, int32 CallFunc_Array_Add_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate7, const struct FFortTeamMemberInfo& K2Node_CustomEvent_PlayerInfo, class UFortPartyContext* CallFunc_GetContext_ReturnValue3, enum class EFortPartyState K2Node_CustomEvent_PartyState, bool CallFunc_EqualEqual_ByteByte_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate8, bool CallFunc_EqualEqual_ByteByte_ReturnValue2, class UFortPartyContext* CallFunc_GetContext_ReturnValue4, bool CallFunc_BooleanOR_ReturnValue, enum class EMatchmakingCompleteResult K2Node_CustomEvent_Result, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue5, bool CallFunc_EqualEqual_ByteByte_ReturnValue3, bool CallFunc_IsInZone_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UObject* K2Node_CustomEvent_Item, bool K2Node_CustomEvent_bIsSelected, class UFortQuestItem* K2Node_DynamicCast_AsFort_Quest_Item, bool K2Node_DynamicCast_bSuccess4, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue6, class UFortQuestManager* CallFunc_GetQuestManager_ReturnValue2, class UFortQuestItem* CallFunc_GetMainQuest_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue7, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate9)
{
