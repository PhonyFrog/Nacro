...
{
	static auto Func = Class->GetFunction("MissionObjectiveProgress_C", "Construct");

	Params::UMissionObjectiveProgress_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("MissionObjectiveProgress_C", "ExecuteUbergraph_MissionObjectiveProgress");
