...
public:
	...
	void InitializeLootChest(int32 Level, int32 NewLocalVar_0, class UTexture2D* Texture, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, class UTexture2D* CallFunc_Array_Get_Item, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue, bool CallFunc_Array_IsValidIndex_ReturnValue);
