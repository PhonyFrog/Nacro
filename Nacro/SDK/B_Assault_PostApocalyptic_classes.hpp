...
{
// 0x10 (0xDF8 - 0xDE8)
// BlueprintGeneratedClass B_Assault_PostApocalyptic.B_Assault_PostApocalyptic_C
class AB_Assault_PostApocalyptic_C : public AB_Assault_Generic_C
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("B_Assault_PostApocalyptic_C");
		return Clss;
	}
