...
bool UAnimNotify_MeleeAnimTrails_Off_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, bool CallFunc_IsDedicatedServer_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, class APlayerPawn_Generic_C* K2Node_DynamicCast_AsPlayer_Pawn_Generic, bool K2Node_DynamicCast_bSuccess)
{
	static auto Func = Class->GetFunction("AnimNotify_MeleeAnimTrails_Off_C", "Received_Notify");

	Params::UAnimNotify_MeleeAnimTrails_Off_C_Received_Notify_Params Parms;
