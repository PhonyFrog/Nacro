...
{
// 0x10 (0xDF8 - 0xDE8)
// BlueprintGeneratedClass B_Rifle_PostApocalyptic.B_Rifle_PostApocalyptic_C
class AB_Rifle_PostApocalyptic_C : public AB_Rifle_Generic_C
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("B_Rifle_PostApocalyptic_C");
		return Clss;
	}
