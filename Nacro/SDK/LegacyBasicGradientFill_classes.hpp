...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("LegacyBasicGradientFill_C");
		return Clss;
	}
	...
	void ExecuteUbergraph_LegacyBasicGradientFill(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
