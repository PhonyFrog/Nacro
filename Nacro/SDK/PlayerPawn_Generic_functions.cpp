...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "GameplayCue.GravitySphere");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "CleanupGravitySphereFootEffects");

	Params::APlayerPawn_Generic_C_CleanupGravitySphereFootEffects_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "Entered WaterVolume");

	Params::APlayerPawn_Generic_C_Entered_WaterVolume_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "GameplayCue.Generic.AdrenalineRush.PeriodicHeal");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "MultiEndAnimTrails");

	Params::APlayerPawn_Generic_C_MultiEndAnimTrails_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "DisableAnimTrails");

	Params::APlayerPawn_Generic_C_DisableAnimTrails_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "AnimTrailsCE");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "SetupAnimTrails");
