...
{
public:
	struct FDynamicQuestUpdateInfo               UpdateInfo;                                        // 0x0(0x20)(Parm, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_24C4[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDynamicQuestUpdateInfo               K2Node_MakeStruct_DynamicQuestUpdateInfo;          // 0x20(0x20)(HasGetValueTypeHash)
	struct FDynamicQuestUpdateInfo               K2Node_MakeStruct_DynamicQuestUpdateInfo2;         // 0x40(0x20)(HasGetValueTypeHash)
