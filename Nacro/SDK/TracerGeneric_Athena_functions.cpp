...
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_C", "GetLocalPawnForPassBy");

	Params::ATracerGeneric_Athena_C_GetLocalPawnForPassBy_Params Parms;
...
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_C", "PlayPassBySound");

	Params::ATracerGeneric_Athena_C_PlayPassBySound_Params Parms;
...
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_C", "TrackPassBy");

	Params::ATracerGeneric_Athena_C_TrackPassBy_Params Parms;
...
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_C", "UserConstructionScript");

	Params::ATracerGeneric_Athena_C_UserConstructionScript_Params Parms;
	Parms.CallFunc_K2_SetRelativeRotation_SweepHitResult = CallFunc_K2_SetRelativeRotation_SweepHitResult;

	UObject::ProcessEvent(Func, &Parms);
}

// Function TracerGeneric_Athena.TracerGeneric_Athena_C.ReceiveTick
// (Event, Public, BlueprintEvent)
// Parameters:
// float                              DeltaSeconds                                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ATracerGeneric_Athena_C::ReceiveTick(float DeltaSeconds)
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_C", "ReceiveTick");

	Params::ATracerGeneric_Athena_C_ReceiveTick_Params Parms;
...
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_C", "OnInit");

	Params::ATracerGeneric_Athena_C_OnInit_Params Parms;
	Parms.Start = Start;
	Parms.End = End;
...
void ATracerGeneric_Athena_C::ExecuteUbergraph_TracerGeneric_Athena(int32 EntryPoint, float K2Node_Event_DeltaSeconds, bool CallFunc_TrackPassBy_Changed, float CallFunc_TrackPassBy_Pass_Distance, bool CallFunc_Not_PreBool_ReturnValue, const struct FVector& K2Node_Event_Start, const struct FVector& K2Node_Event_End, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_TrackPassBy_Changed2, float CallFunc_TrackPassBy_Pass_Distance2, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue2, float CallFunc_MapRangeClamped_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue)
{
	static auto Func = Class->GetFunction("TracerGeneric_Athena_C", "ExecuteUbergraph_TracerGeneric_Athena");

	Params::ATracerGeneric_Athena_C_ExecuteUbergraph_TracerGeneric_Athena_Params Parms;
