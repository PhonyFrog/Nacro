...
public:
	...
	class FText                                  K2Node_CustomEvent_StatusText;                     // 0xF0(0x18)()
	class FText                                  K2Node_CustomEvent_FailReason;                     // 0x108(0x18)()
	...
	class FText                                  CallFunc_GetEULAText_ReturnValue;                  // 0x150(0x18)()
