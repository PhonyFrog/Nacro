...
public:
	...
	void OnSelected();
	void OnHovered();
	void ExecuteUbergraph_ItemTransformKeyPickerTileButton(int32 EntryPoint, bool Temp_bool_Variable, class UObject* K2Node_Event_InData, class UCommonListView* K2Node_Event_OwningList, bool CallFunc_IsValid_ReturnValue, class UWidget* K2Node_Select_Default, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UFortCheatManager* K2Node_DynamicCast_AsFort_Cheat_Manager, bool K2Node_DynamicCast_bSuccess, bool CallFunc_ShouldUseNewItemCards_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FVector2D& CallFunc_GetCardDimensions_ReturnValue);
};
