...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingWidget_C", "RefreshInput");

	Params::UAthenaMatchmakingWidget_C_RefreshInput_Params Parms;
...
{
	static auto Func = Class->GetFunction("AthenaMatchmakingWidget_C", "OnActivated");

	Params::UAthenaMatchmakingWidget_C_OnActivated_Params Parms;
