...
public:
	...
	void ExecuteUbergraph_TracerGeneric_Athena_Scope(int32 EntryPoint, float K2Node_Event_DeltaSeconds, bool CallFunc_TrackPassBy_Changed, float CallFunc_TrackPassBy_Pass_Distance, bool CallFunc_Not_PreBool_ReturnValue, const struct FVector& K2Node_Event_Start, const struct FVector& K2Node_Event_End, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_TrackPassBy_Changed2, float CallFunc_TrackPassBy_Pass_Distance2, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, bool CallFunc_BooleanAND_ReturnValue2, float CallFunc_MapRangeClamped_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue);
};
