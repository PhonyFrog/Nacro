...
public:
	...
	struct FFortTagUIData                        CallFunc_GetUIDataForTag_OutData;                  // 0x10(0x398)()
	bool                                         CallFunc_GetUIDataForTag_ReturnValue;              // 0x3A8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	//bool                                       bSucceeded;                                        // 0x8(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	//TArray<struct FFortItemInstanceQuantityPair> Rewards;                                           // 0x10(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
};
