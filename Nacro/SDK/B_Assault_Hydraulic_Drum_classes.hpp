...
{
// 0x18 (0xE00 - 0xDE8)
// BlueprintGeneratedClass B_Assault_Hydraulic_Drum.B_Assault_Hydraulic_Drum_C
class AB_Assault_Hydraulic_Drum_C : public AB_Assault_Bulletswarm_C
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("B_Assault_Hydraulic_Drum_C");
		return Clss;
	}
