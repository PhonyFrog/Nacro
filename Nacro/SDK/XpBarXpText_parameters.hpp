...
public:
	...
	struct FFortPrivateAccountInfo               CallFunc_GetLocalAccountInfo_Result;               // 0x18(0x14)(NoDestructor)
...
public:
	...
	int32                                        CallFunc_Get_Skill_Points_For_Next_Level_Next_Level_Skill_Points; // 0xD8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FFortPublicAccountInfo                K2Node_CustomEvent_NewInfo;                        // 0x4(0x10)(NoDestructor)
