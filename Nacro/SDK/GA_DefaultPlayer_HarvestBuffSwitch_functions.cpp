...
{
	static auto Func = Class->GetFunction("GA_DefaultPlayer_HarvestBuffSwitch_C", "K2_ActivateAbilityFromEvent");

	Params::UGA_DefaultPlayer_HarvestBuffSwitch_C_K2_ActivateAbilityFromEvent_Params Parms;
