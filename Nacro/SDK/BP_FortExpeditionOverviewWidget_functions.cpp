...
{
	static auto Func = Class->GetFunction("BP_FortExpeditionOverviewWidget_C", "Get Utc Now Offset");

	Params::UBP_FortExpeditionOverviewWidget_C_Get_Utc_Now_Offset_Params Parms;
...
void UBP_FortExpeditionOverviewWidget_C::Try_to_Abandon_Expedition(class UFortExpeditionItem* Expedition, const struct FTimespan& CallFunc_Get_Utc_Now_Offset_ReturnValue, bool CallFunc_IsExpeditionInProgress_ReturnValue, bool CallFunc_IsExpeditionCompleted_ReturnValue, bool CallFunc_HandleAbandonExpeditionAction_PassThrough, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
