...
public:
	...
	class UQuestInfo_BulletListEntry_C*          NewEntry;                                          // 0xA8(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UQuestInfo_BulletListEntry_C*          CallFunc_Create_ReturnValue;                       // 0xB0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	class UQuestInfo_BulletListEntry_C*          CallFunc_Create_ReturnValue;                       // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
