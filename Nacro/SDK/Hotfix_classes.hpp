...
{
public:
	uint8                                        Pad_19E7[0x1C8];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_19E8[0x2E];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDateTime                             LastUpdateCheck;                                   // 0x238(0x8)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_19E9[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_19EA[0x17];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19EB[0x368];                                   // Fixing Size After Last Property  [ Dumper-7 ]
