...
public:
	...
	uint8                                        Pad_C0F[0xA7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C10[0xE];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C12[0x18C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C13[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C17[0x40];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C18[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C1C[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
