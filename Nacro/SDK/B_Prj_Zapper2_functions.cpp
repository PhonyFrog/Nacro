...
void AB_Prj_Zapper2_C::OnRep_Impact_Location(class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Prj_Zapper2_C", "OnRep_Impact Location");

	Params::AB_Prj_Zapper2_C_OnRep_Impact_Location_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Zapper2_C", "UserConstructionScript");

	Params::AB_Prj_Zapper2_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Zapper2_C", "ReceiveAnyDamage");

	Params::AB_Prj_Zapper2_C_ReceiveAnyDamage_Params Parms;
	Parms.Damage = Damage;
...
{
	static auto Func = Class->GetFunction("B_Prj_Zapper2_C", "ReceiveBeginPlay");

	Params::AB_Prj_Zapper2_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_Zapper2_C", "OnStop");

	Params::AB_Prj_Zapper2_C_OnStop_Params Parms;
	Parms.Hit = Hit;
