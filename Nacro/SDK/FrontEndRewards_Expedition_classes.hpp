...
public:
	...
	UMulticastDelegateProperty_                  OnExpeditionCompleted;                             // 0x320(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
