...
class UWidget* ULegacyPerkWidget_C::CreateToolTipWidget(TArray<class FText>& CallFunc_GetTooltipDescription_ReturnValue, class FText CallFunc_GetTooltipTitle_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UUserWidget* CallFunc_Create_Basic_Multi_Line_Tooltip_Output)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "CreateToolTipWidget");

	Params::ULegacyPerkWidget_C_CreateToolTipWidget_Params Parms;
...
void ULegacyPerkWidget_C::HighlightBadge(const struct FLinearColor& CallFunc_GetHighlightColor_Color, const struct FLinearColor& CallFunc_GetHighlightColor_Color2, const struct FSlateColor& K2Node_MakeStruct_SlateColor)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "HighlightBadge");

	Params::ULegacyPerkWidget_C_HighlightBadge_Params Parms;
...
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "ShowTierImage");

	Params::ULegacyPerkWidget_C_ShowTierImage_Params Parms;
...
void ULegacyPerkWidget_C::SetupBadge(enum class EFortSupportBonusType SupportPerkType, const struct FSlateBrush& CallFunc_GetTierAbilityBrush_SlateBrush, bool CallFunc_IsTierPerk_ReturnValue, int32 CallFunc_GetRequiredLevel_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "SetupBadge");

	Params::ULegacyPerkWidget_C_SetupBadge_Params Parms;
...
void ULegacyPerkWidget_C::InitializeTextOnlyPerk(const struct FTooltipStat& CallFunc_GetPerkStat_TooltipStat, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UTooltipStatWidget_C* CallFunc_Create_ReturnValue, class UPanelSlot* CallFunc_AddChild_ReturnValue)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "InitializeTextOnlyPerk");

	Params::ULegacyPerkWidget_C_InitializeTextOnlyPerk_Params Parms;
...
void ULegacyPerkWidget_C::ShouldFadePerk(bool* Result, bool CallFunc_IsPerkHighlighted_ReturnValue, bool CallFunc_IsPerkUnlocked_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue2, bool CallFunc_BooleanAND_ReturnValue)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "ShouldFadePerk");

	Params::ULegacyPerkWidget_C_ShouldFadePerk_Params Parms;
...
void ULegacyPerkWidget_C::GetHighlightColor(struct FLinearColor* Color, bool Temp_bool_Variable, const struct FLinearColor& Temp_struct_Variable, const struct FLinearColor& CallFunc_Get_Buff_Color_Color, bool CallFunc_IsPerkHighlighted_ReturnValue, const struct FLinearColor& K2Node_Select_Default)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "GetHighlightColor");

	Params::ULegacyPerkWidget_C_GetHighlightColor_Params Parms;
	Parms.Temp_bool_Variable = Temp_bool_Variable;
...
void ULegacyPerkWidget_C::InitializeBasicPerk(const struct FLinearColor& CallFunc_GetHighlightColor_Color, const struct FSlateBrush& CallFunc_NoResourceBrush_ReturnValue, bool Temp_bool_Variable, const struct FSlateBrush& CallFunc_GetIcon_Brush, bool CallFunc_GetIcon_ReturnValue, const struct FSlateBrush& K2Node_Select_Default, const struct FSlateBrush& CallFunc_ResizeBrush_NewParam)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "InitializeBasicPerk");

	Params::ULegacyPerkWidget_C_InitializeBasicPerk_Params Parms;
	Parms.CallFunc_GetHighlightColor_Color = CallFunc_GetHighlightColor_Color;
...
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "PreConstruct");

	Params::ULegacyPerkWidget_C_PreConstruct_Params Parms;
...
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "Construct");

	Params::ULegacyPerkWidget_C_Construct_Params Parms;
...
void ULegacyPerkWidget_C::ExecuteUbergraph_LegacyPerkWidget(int32 EntryPoint, bool CallFunc_HasAbility_ReturnValue, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush, bool CallFunc_ShouldFadePerk_Result, const struct FLinearColor& K2Node_MakeStruct_LinearColor, bool K2Node_Event_IsDesignTime)
{
	static auto Func = Class->GetFunction("LegacyPerkWidget_C", "ExecuteUbergraph_LegacyPerkWidget");

	Params::ULegacyPerkWidget_C_ExecuteUbergraph_LegacyPerkWidget_Params Parms;
