...
public:
	...
	uint8                                        Pad_2E5B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2E60[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0x1C0(0x90)()
};
...
public:
	...
	struct FSlateBrush                           CallFunc_GetIcon_Brush;                            // 0x98(0x90)()
	bool                                         CallFunc_GetIcon_ReturnValue;                      // 0x128(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2E6A[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           K2Node_Select_Default;                             // 0x130(0x90)()
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0x1C0(0x90)()
};
...
public:
	...
	uint8                                        Pad_2E6D[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
