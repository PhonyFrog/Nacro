...
public:
	...
	class UItemTransformSlotItemPicker_C*        ItemTransformSlotItemPicker;                       // 0x250(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	void ExecuteUbergraph_ItemTransformItemPicker(int32 EntryPoint, bool K2Node_Event_IsDesignTime, class FName K2Node_ComponentBoundEvent_TabId);
