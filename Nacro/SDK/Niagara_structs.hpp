...
{
public:
	uint8                                        Pad_1DA5[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1DA6[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1DA7[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1DA9[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
