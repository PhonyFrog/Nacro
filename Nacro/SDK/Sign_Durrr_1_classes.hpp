...
{
// 0xC (0x10E0 - 0x10D4)
// BlueprintGeneratedClass Sign_Durrr_1.Sign_Durrr_1_C
class ASign_Durrr_1_C : public AParent_BuildingPropActor_C
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("Sign_Durrr_1_C");
		return Clss;
	}
