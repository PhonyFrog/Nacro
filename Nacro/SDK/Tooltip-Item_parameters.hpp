...
public:
	...
	enum class ESlateVisibility                  CallFunc_Get_Tooltip_Header_Text_Visibility_ReturnValue; // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  CallFunc_Get_Tooltip_Header_Icon_Visibility_ReturnValue; // 0x5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	struct FLinearColor                          CallFunc_Get_Theme_Color_Theme_Color;              // 0x10(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
