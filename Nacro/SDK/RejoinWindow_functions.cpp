...
// float                              LocalTimeoutSeconds                                              (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void URejoinWindow_C::ShowInitalScreen(float TimeoutSeconds, float LocalTimeoutSeconds, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle2, TArray<struct FDataTableRowHandle>& K2Node_MakeArray_Array)
{
...
// bool                               LocalAllowRetry                                                  (Edit, ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                        LocalRetryFailure                                                (Edit)
// float                              LocalTimeoutSeconds                                              (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FDataTableRowHandle         K2Node_MakeStruct_DataTableRowHandle                             (NoDestructor)
...
void URejoinWindow_C::ShowRetryScreen(class FText Failure, float TimeoutSeconds, bool AllowRetry, bool LocalAllowRetry, class FText LocalRetryFailure, float LocalTimeoutSeconds, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, int32 CallFunc_Array_Add_ReturnValue, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle2, int32 CallFunc_Array_Add_ReturnValue2)
{
	...
	Parms.LocalRetryFailure = LocalRetryFailure;
	Parms.LocalTimeoutSeconds = LocalTimeoutSeconds;
	Parms.K2Node_MakeStruct_DataTableRowHandle = K2Node_MakeStruct_DataTableRowHandle;
