...
{
public:
	TArray<struct FManagedGameplayTagDataTableItem> Tables;                                            // 0x28(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2450[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
