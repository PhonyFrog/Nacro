...
{
public:
	class FText                                  NewText;                                           // 0x0(0x18)(Parm)
};
...
public:
	...
	enum class EFortQuestType                    CallFunc_GetQuestType_ReturnValue;                 // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x3(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue2;         // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
{
public:
	class UFortQuestItemDefinition*              Item;                                              // 0x0(0x8)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EFortQuestType                    CallFunc_GetQuestType_ReturnValue;                 // 0x9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue3;         // 0xC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	enum class EFortQuestType                    CallFunc_GetQuestType_ReturnValue;                 // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array2;                           // 0xF8(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x108(0x18)()
	class FText                                  K2Node_Select_Default;                             // 0x120(0x18)()
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue2;         // 0x138(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
