...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("Prop_Sign_BacklitMenu_02_C");
		return Clss;
	}

	void UserConstructionScript(class ULightComponent* Temp_object_Variable, int32 CallFunc_Array_Add_ReturnValue);
};
