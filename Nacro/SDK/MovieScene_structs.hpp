...
public:
	...
	uint8                                        bEvaluateNearestSection : 1;                       // Mask : 0x2 0x0(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_19C5[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19C7[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19C8[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19C9[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19CA[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19CC[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_19CD[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        bEvaluateInPreroll : 1;                            // Mask : 0x1 0x78(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        bEvaluateInPostroll : 1;                           // Mask : 0x2 0x78(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	float                                        PrerollTime;                                       // 0x8(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        PostrollTime;                                      // 0xC(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_19D1[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_19D2[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        bHasLegacyTrackInstances : 1;                      // Mask : 0x1 0x218(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bKeepStaleTracks : 1;                              // Mask : 0x2 0x218(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_19D3[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19D4[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
