...
public:
	...
	struct FFortDailyRewardsData                 CallFunc_TryGetDailyRewardsData_OutDailyRewardsData; // 0xB8(0x18)()
	...
	struct FFortDailyRewardsScheduleData         CallFunc_Array_Get_Item;                           // 0xD8(0x98)()
