...
{
public:
	uint8                                        Pad_1FD8[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1FDB[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1FDF[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1FE1[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1FE2[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FRichCurve                            Shear;                                             // 0x268(0x70)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1FE3[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
