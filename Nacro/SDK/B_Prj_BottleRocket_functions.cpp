...
void AB_Prj_BottleRocket_C::UserConstructionScript(class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Prj_BottleRocket_C", "UserConstructionScript");

	Params::AB_Prj_BottleRocket_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Prj_BottleRocket_C", "ReceiveBeginPlay");

	Params::AB_Prj_BottleRocket_C_ReceiveBeginPlay_Params Parms;
...
void AB_Prj_BottleRocket_C::OnBounce(struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("B_Prj_BottleRocket_C", "OnBounce");

	Params::AB_Prj_BottleRocket_C_OnBounce_Params Parms;
	Parms.Hit = Hit;
...
void AB_Prj_BottleRocket_C::OnExploded(TArray<class AActor*>& HitActors, TArray<struct FHitResult>& HitResults)
{
	static auto Func = Class->GetFunction("B_Prj_BottleRocket_C", "OnExploded");

	Params::AB_Prj_BottleRocket_C_OnExploded_Params Parms;
