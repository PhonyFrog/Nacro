...
public:
	...
	void Init(class AFortPlayerStateOutpost* InPlayer, class AFortPlayerStateOutpost* InOutpostOwner, bool CallFunc_CanEditOutpost_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue);
