...
public:
	...
	class ULegacyPerkWidget_C*                   CallFunc_Create_ReturnValue;                       // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        Temp_int_Variable;                                 // 0x28(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_28D4[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FFortUIPerk                           CallFunc_Array_Get_Item;                           // 0x30(0x88)()
	...
	class APlayerController*                     CallFunc_GetOwningPlayer_ReturnValue2;             // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<struct FFortUIPerk>                   CallFunc_GetSupportBonusPerks_SupportBonusPerks;   // 0xF0(0x10)(ZeroConstructor, ReferenceParm)
	bool                                         CallFunc_GetSupportBonusPerks_ReturnValue;         // 0x100(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_28D7[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ULegacyPerkWidget_C*                   CallFunc_Create_ReturnValue2;                      // 0x108(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UHorizontalBoxSlot*                    CallFunc_AddChildToHorizontalBox_ReturnValue;      // 0x110(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        Temp_float_Variable2;                              // 0x124(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_Select2_Default;                            // 0x128(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FMargin                               K2Node_MakeStruct_Margin2;                         // 0x12C(0x10)(NoDestructor)
};
