...
public:
	...
	struct FTimerHandle                          ContinueTutorialTimer;                             // 0x2B0(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	...
	void ExecuteUbergraph_Announcement_Tutorial(int32 EntryPoint, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FFortClientAnnouncementData_Tutorial& K2Node_MakeStruct_FortClientAnnouncementData_Tutorial, class UObject* K2Node_HandleClientEvent_EventSource2, class UObject* K2Node_HandleClientEvent_EventFocus2, const struct FFortClientEvent& K2Node_HandleClientEvent_ClientEvent2, class UObject* K2Node_HandleClientEvent_EventSource, class UObject* K2Node_HandleClientEvent_EventFocus, const struct FFortClientEvent& K2Node_HandleClientEvent_ClientEvent, const struct FFortClientAnnouncementData_Tutorial& K2Node_CustomEvent_TutorialData, bool K2Node_CustomEvent_bShow, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate2, class UFortTutorialContext* CallFunc_GetContext_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue2);
};
