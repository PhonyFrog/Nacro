...
public:
	...
	class UHomeBaseContext*                      CallFunc_GetContext_ReturnValue2;                  // 0xB8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHomebaseSquad                        CallFunc_TryGetHomebaseSquadData_OutHomebaseSquad2; // 0xD8(0x88)()
	bool                                         CallFunc_TryGetHomebaseSquadData_ReturnValue2;     // 0x160(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue2;         // 0x161(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	enum class ESlateVisibility                  K2Node_Select_Default;                             // 0x172(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
