...
{
	static auto Func = Class->GetFunction("BP_ItemTransform_TabButton_C", "Update Air Vehicles");
...
{
	static auto Func = Class->GetFunction("BP_ItemTransform_TabButton_C", "Update Sea Vehicles");
...
{
	static auto Func = Class->GetFunction("BP_ItemTransform_TabButton_C", "Update Land Vehicles");
...
{
	static auto Func = Class->GetFunction("BP_ItemTransform_TabButton_C", "Update All Vehicles");
...
{
	static auto Func = Class->GetFunction("BP_ItemTransform_TabButton_C", "Update Available Vehicles");
...
// struct FSlateColor                 K2Node_MakeStruct_SlateColor7                                    ()
