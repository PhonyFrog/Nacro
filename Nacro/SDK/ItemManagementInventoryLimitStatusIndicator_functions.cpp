...
void UItemManagementInventoryLimitStatusIndicator_C::TrackStorageInventory(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortInventoryContext* CallFunc_GetContext_ReturnValue)
{
...
void UItemManagementInventoryLimitStatusIndicator_C::TrackVaultInventory(UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortInventoryContext* CallFunc_GetContext_ReturnValue)
{
	static auto Func = Class->GetFunction("ItemManagementInventoryLimitStatusIndicator_C", "TrackVaultInventory");

	Params::UItemManagementInventoryLimitStatusIndicator_C_TrackVaultInventory_Params Parms;
	Parms.K2Node_CreateDelegate_OutputDelegate = K2Node_CreateDelegate_OutputDelegate;
	Parms.CallFunc_GetContext_ReturnValue = CallFunc_GetContext_ReturnValue;
