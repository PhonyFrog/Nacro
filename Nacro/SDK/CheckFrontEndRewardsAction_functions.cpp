...
// bool                               CallFunc_IsShowingModalsConfirmationsErrors_bShowing             (ZeroConstructor, IsPlainOldData, NoDestructor)
...
bool ACheckFrontEndRewardsAction_C::CanShowFrontendRewards(class UFortMatchmakingContext* CallFunc_GetContext_ReturnValue, class UFortUIManagerWidget_NUI* CallFunc_GetUIManagerWidget_ReturnValue, bool CallFunc_IsInLobby_ReturnValue, class UUIManager_C* K2Node_DynamicCast_AsUIManager, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsMatchmakingLocal_ReturnValue, bool CallFunc_IsShowingModalsConfirmationsErrors_bShowing, class UFortStoreContext* CallFunc_GetContext_ReturnValue2, bool CallFunc_BooleanOR_ReturnValue, enum class EFortStoreState CallFunc_GetStoreState_ReturnValue, bool CallFunc_BooleanOR_ReturnValue2, bool CallFunc_NotEqual_ByteByte_ReturnValue, class UFortPartyContext* CallFunc_GetContext_ReturnValue3, bool CallFunc_BooleanOR_ReturnValue3, enum class EFortPartyMemberLocation CallFunc_GetLocalPartyMemberLocation_Location, bool CallFunc_GetLocalPartyMemberLocation_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue2, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanOR_ReturnValue4, bool CallFunc_Not_PreBool_ReturnValue)
{
	...
	Parms.CallFunc_IsShowingModalsConfirmationsErrors_bShowing = CallFunc_IsShowingModalsConfirmationsErrors_bShowing;
