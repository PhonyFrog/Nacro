...
class ARecreation_Park_Swing03_C : public ABuildingProp
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("Recreation_Park_Swing03_C");
		return Clss;
	}
