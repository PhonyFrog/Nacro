...
{
public:
	enum class ESlateVisibility                  NewParam;                                          // 0x0(0x1)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	enum class ESlateVisibility                  CallFunc_GetButtonVisibility_NewParam;             // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
