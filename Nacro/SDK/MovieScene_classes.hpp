...
public:
	...
	uint8                                        Pad_19B4[0x78];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19B9[0x358];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        bIsPlaying : 1;                                    // Mask : 0x1 0x3B0(0x1)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        bReversePlayback : 1;                              // Mask : 0x2 0x3B0(0x1)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        bPendingFirstUpdate : 1;                           // Mask : 0x4 0x3B0(0x1)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_19BB[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_19BC[0x288];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        bIsActive : 1;                                     // Mask : 0x1 0xC4(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        bIsLocked : 1;                                     // Mask : 0x2 0xC4(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        bIsInfinite : 1;                                   // Mask : 0x4 0xC4(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_19BE[0xB];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_19BF[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_19C0[0xE];                                     // Fixing Size Of Struct [ Dumper-7 ]
