...
{
// 0xC (0x10E0 - 0x10D4)
// BlueprintGeneratedClass Sign_Durrr_4.Sign_Durrr_4_C
class ASign_Durrr_4_C : public AParent_BuildingPropActor_C
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("Sign_Durrr_4_C");
		return Clss;
	}
