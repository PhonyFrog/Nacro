...
// class UFullPartyBar_C*             CallFunc_Create_ReturnValue                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UMainMenu_C::ConfigureSubGameWidgets(class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFullPartyBar_C* CallFunc_Create_ReturnValue, class UPanelSlot* CallFunc_AddChild_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
...
void UMainMenu_C::RefreshFriendCodesButton(int32 CallFunc_GetTotalNumFriendCodes_Num_Codes, int32 CallFunc_GetTotalNumFriendCodes_Num_Codes2, bool CallFunc_Greater_IntInt_ReturnValue, class FText CallFunc_Conv_IntToText_ReturnValue)
{
...
// class UNews_C*                     CallFunc_Create_ReturnValue3                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UPermissionsRoot_C*          CallFunc_Create_ReturnValue4                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ULegalInfo_C*                CallFunc_Create_ReturnValue5                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UCredits_C*                  CallFunc_Create_ReturnValue6                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UOptionsMenu_C*              CallFunc_Create_ReturnValue7                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UMessageCenterWidget_C*      CallFunc_Create_ReturnValue8                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UMainMenu_C::InitializeMainMenu(class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, int32 Temp_int_Array_Index_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable2, bool Temp_bool_Variable, enum class ESlateVisibility K2Node_Select_Default, TArray<class UIconTextButton_C*>& K2Node_MakeArray_Array, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UIconTextButton_C* CallFunc_Array_Get_Item, class UPrivacyWidget_C* CallFunc_Create_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class UFortUIDataConfigurationContext* CallFunc_GetContext_ReturnValue2, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_ArePartyFeaturesEnabled_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue2, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue3, class UShowFriendCodesSelection_C* CallFunc_Create_ReturnValue2, bool CallFunc_AllowQuit_ReturnValue, bool CallFunc_IsInZone_ReturnValue2, enum class ESlateVisibility Temp_byte_Variable3, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_IsOutpostOwner_OutpostOwner, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue4, bool CallFunc_AllowLogout_ReturnValue, enum class ESlateVisibility Temp_byte_Variable4, enum class ESlateVisibility Temp_byte_Variable5, bool Temp_bool_Variable2, enum class ESlateVisibility K2Node_Select2_Default, enum class ESlateVisibility Temp_byte_Variable6, bool Temp_bool_Variable3, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue3, enum class ESlateVisibility K2Node_Select3_Default, class UNews_C* CallFunc_Create_ReturnValue3, class UPermissionsRoot_C* CallFunc_Create_ReturnValue4, class ULegalInfo_C* CallFunc_Create_ReturnValue5, class UCredits_C* CallFunc_Create_ReturnValue6, class UOptionsMenu_C* CallFunc_Create_ReturnValue7, class UMessageCenterWidget_C* CallFunc_Create_ReturnValue8)
{
