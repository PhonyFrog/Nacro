...
public:
	...
	uint8                                        Pad_2697[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	class UFortQuestItem*                        QuestItem;                                         // 0x0(0x8)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	enum class EFortQuestRewardType              CallFunc_GetRewardType_ReturnValue;                // 0x11(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x12(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2698[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	enum class EFortQuestRewardType              CallFunc_GetRewardType_ReturnValue;                // 0x21(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	class FText                                  CallFunc_GetDataFromSentence_Text;                 // 0xB0(0x18)()
	class UTexture2D*                            CallFunc_GetDataFromSentence_TalkingHeadTexture;   // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
