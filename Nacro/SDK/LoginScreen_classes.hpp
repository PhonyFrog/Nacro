...
public:
	...
	void ShowResultWindow(class FText Title, class FText Description, bool bShowError, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class ULoginResultWIdget_C* CallFunc_Create_ReturnValue, bool CallFunc_IsValid_ReturnValue);
