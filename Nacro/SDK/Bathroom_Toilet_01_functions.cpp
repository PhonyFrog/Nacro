...
{
	static auto Func = Class->GetFunction("Bathroom_Toilet_01_C", "UserConstructionScript");

	Params::ABathroom_Toilet_01_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("Bathroom_Toilet_01_C", "OnLoot");

	Params::ABathroom_Toilet_01_C_OnLoot_Params Parms;
...
void ABathroom_Toilet_01_C::OnDeathPlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("Bathroom_Toilet_01_C", "OnDeathPlayEffects");

	Params::ABathroom_Toilet_01_C_OnDeathPlayEffects_Params Parms;
	Parms.Damage = Damage;
