...
class AB_Prj_Ranged_GrenadeLauncher_C : public AFortProjectileBase
{
public:
	...
	class AActor*                                SpawnBounceFXHitActor;                             // 0x8A8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("B_Prj_Ranged_GrenadeLauncher_C");
		return Clss;
	}
