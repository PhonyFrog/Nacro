...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_Parent_C", "Teleport");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_Parent_C", "GameplayCue.Teleport.Out");
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_Parent_C", "GameplayCue.Teleport.In");
