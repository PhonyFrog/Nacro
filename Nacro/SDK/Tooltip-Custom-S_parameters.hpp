...
public:
	...
	enum class ESlateVisibility                  K2Node_Select2_Default;                            // 0x14(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x15(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  K2Node_Select3_Default;                            // 0x16(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	enum class ESlateVisibility                  K2Node_Select4_Default;                            // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
