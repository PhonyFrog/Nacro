...
{
// 0x10 (0xDF8 - 0xDE8)
// BlueprintGeneratedClass B_Pistol_PostApocalyptic.B_Pistol_PostApocalyptic_C
class AB_Pistol_PostApocalyptic_C : public AB_Pistol_Auto_C
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("B_Pistol_PostApocalyptic_C");
		return Clss;
	}
