...
public:
	...
	struct FVector                               CallFunc_GetSocketLocation_ReturnValue2;           // 0x40(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue2;     // 0xC4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3E0D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UParticleSystemComponent*              CallFunc_SpawnEmitterAtLocation_ReturnValue;       // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UParticleSystemComponent*              CallFunc_SpawnEmitterAttached_ReturnValue;         // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
