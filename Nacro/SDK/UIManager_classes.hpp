...
public:
	...
	void HandleDeactivatedErrorWindow(class UCommonActivatablePanel* DeactivatedPanel, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate);
	...
	void QueueConfirmation(const struct FFortDialogDescription_NUI& ConfirmationDescription, bool CallFunc_IsStateContentChildShowing_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_BooleanAND_ReturnValue);
