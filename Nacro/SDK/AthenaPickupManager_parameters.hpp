...
public:
	...
	uint8                                        Pad_2A03[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	bool                                         CallFunc_GetMessageManager_bCreatedNew;            // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2A06[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UFortUIMessageManager*                 CallFunc_GetMessageManager_ReturnValue;            // 0xA0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
