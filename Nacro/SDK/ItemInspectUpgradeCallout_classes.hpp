...
public:
	...
	UMulticastDelegateProperty_                  OnRequestUpgrade;                                  // 0x2A8(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FLinearColor                          UpgradeColor;                                      // 0x2B8(0x10)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void ExecuteUbergraph_ItemInspectUpgradeCallout(int32 EntryPoint, class UCommonButton* K2Node_ComponentBoundEvent_Button, class UCommonButton* K2Node_ComponentBoundEvent_Button2);
