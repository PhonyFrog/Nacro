...
{
public:
	struct FMaterialQualityOverrides             QualityOverrides;                                  // 0x28(0x6)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_1E1B[0x12];                                    // Fixing Size Of Struct [ Dumper-7 ]
