...
public:
	...
	bool AddGameplayTagToContainer(struct FGameplayTagContainer& TagContainer, struct FGameplayTag& Tag);
	void AddGameplayTag(struct FGameplayTagContainer& InOutTagContainer, const struct FGameplayTag& Tag);
};
...
public:
	...
	TArray<struct FStringAssetReference>         GameplayTagTableList;                              // 0x68(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
